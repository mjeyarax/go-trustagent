...
replace intel/isecl/lib/common => gitlab.devtools.intel.com/sst/isecl/lib/common v2.0/develop

replace intel/isecl/lib/tpmprovider => gitlab.devtools.intel.com/sst/isecl/lib/tpm-provider.git v2.0/develop
