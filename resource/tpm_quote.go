...
func (tpmQuoteResponse *TpmQuoteResponse) getQuote(tpmQuoteRequest *TpmQuoteRequest) error {
	tpmQuoteResponse.Quote = base64.StdEncoding.EncodeToString([]byte("Nothing here yere"))
	return nil // TBD
}
...
func createTpmQuote(tpmQuoteRequest *TpmQuoteRequest) (*TpmQuoteResponse, error) {
	...
	// selected pcr banks
	err = tpmQuoteResponse.getSelectedPcrBanks(tpmQuoteRequest)
	if err != nil {
		return nil, err
	}
